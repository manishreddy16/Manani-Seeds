        ...
        <div className="grid lg:grid-cols-2 gap-12 items-start">
          ...
          >
            ...
            <motion.div
              ...
              className="absolute -bottom-12 left-1/2 z-10 h-72 w-56 -translate-x-1/2 sm:-bottom-16 sm:h-96 sm:w-72"
            >
              <MediaFrame
                ...
                rounded="rounded-2xl"
                fit="contain"
                className="h-full w-full shadow-soft"
              />
            </motion.div>
            {comingSoon && (
            ...
            {related.map((p) => (
              ...
              >
                <MediaFrame
                  ...
                  fit="contain"
                  className="aspect-[9/16] w-full mb-4"
                />

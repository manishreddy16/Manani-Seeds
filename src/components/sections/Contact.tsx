        ...
        >
          ...
          <div className="relative mt-10 flex flex-col items-center justify-center gap-4 sm:flex-row">
            ...
            <a
              ...
              className="inline-flex items-center gap-2 rounded-full border border-white/35 bg-white/15 px-8 py-4 font-semibold text-white transition-colors hover:bg-white/25"
            >
              <Phone size={19} />
